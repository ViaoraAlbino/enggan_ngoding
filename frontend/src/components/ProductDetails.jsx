    ...
    <div className="p-6 bg-blue-100 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto bg-white p-6 md:p-10 rounded-lg shadow-md mt-10">
        <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-10">
          ...
          <div className="flex-1">
            <h6 className="text-lg font-bold">KAOS CUSTOM</h6>
            <h6 className="text-xl font-bold text-blue-700">Rp.50.000</h6>
            <table className="w-full mt-4">
              <tbody>
                {/* Warna */}
                <tr>
                  <td className="py-2">Warna</td>
                  <td className="py-2">
                    <div className="flex space-x-4">
                      <div className="flex items-center space-x-2">
                        <img
                          ...
                          alt="Putih"
                        />
                        <button className="text-sm">Putih</button>
                      </div>
                      <div className="flex items-center space-x-2">
                        <img
                          ...
                          alt="Hitam"
                        />
                        <button className="text-sm">Hitam</button>
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="py-2">
                    <div className="flex items-center space-x-4">
                      <button
                        onClick={() => handleQuantityChange(-1)}
                        className="px-4 py-2 border bg-gray-200 rounded-md"
                      >
                        -
                      </button>
                      <span>{quantity}</span>
                ...
                {/* File Desain */}
                <tr>
                  <td className="py-2">File Desain</td>
                  <td className="py-2">
                    <input
                      type="file"
            ...
            <div className="mt-6 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <button className="px-6 py-3 bg-blue-200 rounded-md hover:bg-blue-300">
                Masukkan Keranjang
              </button>
              <button className="px-6 py-3 bg-blue-700 text-white rounded-md hover:bg-blue-800">
                Pesan Sekarang
              </button>
            </div>
          </div>
      ...
      <div className="mt-10">
        <div className="flex space-x-2">
          <button
            onClick={() => handleTabClick('Deskripsi')}
            className={`px-4 py-2 ${activeTab === 'Deskripsi' ? 'bg-blue-700 text-white' : 'bg-gray-200'} rounded-t-md`}
          >
            Deskripsi
          </button>
          <button
            onClick={() => handleTabClick('Review')}
            className={`px-4 py-2 ${activeTab === 'Review' ? 'bg-blue-700 text-white' : 'bg-gray-200'} rounded-t-md`}
          >
            Review
          </button>
        </div>
        <div className="p-4 bg-white rounded-md">
          {activeTab === 'Deskripsi' && <p>Konten Deskripsi...</p>}
          {activeTab === 'Review' && <p>Konten Review...</p>}
        </div>
      </div>
    </div>
  );
